...
#ifndef AGENTOS_PARTDATA_TRACE_H
#define AGENTOS_PARTDATA_TRACE_H
 ...
 * @brief 追踪导出器配置
 */
typedef struct partdata_trace_exporter_config {
    bool enabled;
    char export_path[256];
    size_t batch_size;
    uint32_t export_interval_sec;
    char export_format[16];
} partdata_trace_exporter_config_t;
...
#endif /* AGENTOS_PARTDATA_TRACE_H */
