#!/bin/bash
# =============================================================================
# AgentOS domes Module Build Log Collector
# Version: 1.0.0
...
---
*Generated by domes build log collector*
EOF
...
archive_logs() {
    local log_dir="$1"
    local archive_name="domes_build_logs_$(basename "$log_dir").tar.gz"
