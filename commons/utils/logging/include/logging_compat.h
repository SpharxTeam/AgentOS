 ...
 * 
 * 支持的现有API�? * 1. `atoms/utils/observability/include/logger.h` 中的API
 * 2. `commons/utils/observability/include/logger.h` 中的API
 * 3. `daemon/commons/include/svc_logger.h` 中的API（部分）
 * 
