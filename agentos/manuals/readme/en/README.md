...
```
AgentOS/
├── agentos/manager/                      # Configuration center
...
│
├── agentos/atoms/                       # Kernel layer (microkernel architecture)
...
│
├── agentos/toolkit/                       # Multi-language SDK
│   ├── go/                     # Go SDK
│   ├── python/                 # Python SDK
│   ├── rust/                   # Rust SDK
│   └── typescript/             # TypeScript SDK
│
├── agentos/daemon/                       # Core background services (user-space)
...
│
├── openlab/                     # Open ecosystem hub (official apps + community contributions)
...
│
├── agentos/heapstore/                    # Data partition (runtime data)
│   ├── kernel/                 # Kernel data
...
│
├── agentos/manuals/                    # Technical documentation center
...
See: [CoreLoopThree Architecture Document](agentos/manuals/architecture/coreloopthree.md)
...
See: [MemoryRovol Architecture Document](agentos/manuals/architecture/memoryrovol.md)
...
See: [Logging System Architecture Document](agentos/manuals/architecture/logging_system.md)
...
- [📘 CoreLoopThree Architecture](agentos/manuals/architecture/coreloopthree.md) - Three-layer runtime
- [💾 MemoryRovol Architecture](agentos/manuals/architecture/memoryrovol.md) - Memory roll system
- [🔧 IPC Mechanism](agentos/manuals/architecture/ipc.md) - Inter-process communication
- [⚙️ Microkernel Design](agentos/manuals/architecture/microkernel.md) - Microkernel architecture
- [📞 System Calls](agentos/manuals/architecture/syscall.md) - System call interface
- [📝 Logging System](agentos/manuals/architecture/logging_system.md) - Cross-language logging

### Development Guides

- [🚀 Quick Start](agentos/manuals/guides/getting_started.md) - Getting started guide
- [🤖 Create Agent](agentos/manuals/guides/create_agent.md) - Agent development tutorial
- [🛠️ Create Skill](agentos/manuals/guides/create_skill.md) - Skill development tutorial
- [📦 Deployment Guide](agentos/manuals/guides/deployment.md) - Production deployment
- [🎛️ Kernel Tuning](agentos/manuals/guides/kernel_tuning.md) - Performance optimization guide
- [🔍 Troubleshooting](agentos/manuals/guides/troubleshooting.md) - commons issues

### Technical Specifications

- [📋 Coding Standards](agentos/manuals/specifications/coding_standards.md) - Development standards
- [🧪 Testing Standards](agentos/manuals/specifications/testing.md) - Testing requirements
- [🔒 Security Standards](agentos/manuals/specifications/security.md) - Security practices
- [📊 Performance Metrics](agentos/manuals/specifications/performance.md) - Performance requirements
