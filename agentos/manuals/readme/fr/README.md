...
│                                                             │
│  ┌───────────────────────────────────────────────────────┐  │
│  │           Couche Application (openlab)                │  │
│  │  docgen | ecommerce | research | videoedit | ...      │  │
│  └───────────────────────────────────────────────────────┘  │
│                           ↕                                 │
│  ┌───────────────────────────────────────────────────────┐  │
│  │        Couche Services Principaux (daemon)             │  │
...
Voir: [Documentation CoreLoopThree](agentos/manuals/architecture/coreloopthree.md)
...
Voir: [Documentation MemoryRovol](agentos/manuals/architecture/memoryrovol.md)
...
Voir: [Documentation Logging](agentos/manuals/architecture/logging_system.md)
...
- [📘 Architecture CoreLoopThree](agentos/manuals/architecture/coreloopthree.md)
- [💾 Architecture MemoryRovol](agentos/manuals/architecture/memoryrovol.md)
- [🔧 Mécanisme IPC](agentos/manuals/architecture/ipc.md)
- [⚙️ Conception Micro-noyau](agentos/manuals/architecture/microkernel.md)
- [📞 Appels Système](agentos/manuals/architecture/syscall.md)
- [📝 Système Journalisation](agentos/manuals/architecture/logging_system.md)

### Guides Développement

- [🚀 Démarrage Rapide](agentos/manuals/guides/getting_started.md)
- [🤖 Créer Agent](agentos/manuals/guides/create_agent.md)
- [🛠️ Créer Compétence](agentos/manuals/guides/create_skill.md)
- [📦 Déploiement](agentos/manuals/guides/deployment.md)
- [🎛️ Optimisation Noyau](agentos/manuals/guides/kernel_tuning.md)
- [🔍 Dépannage](agentos/manuals/guides/troubleshooting.md)

### Spécifications Techniques

- [📋 Standards Code](agentos/manuals/specifications/coding_standards.md)
- [🧪 Standards Tests](agentos/manuals/specifications/testing.md)
- [🔒 Standards Sécurité](agentos/manuals/specifications/security.md)
- [📊 Performances](agentos/manuals/specifications/performance.md)
...
|----------|----------|----------|
| `agentos/atoms/` (Noyau) | Apache License 2.0 | CoreLoopThree, MemoryRovol, runtime, isolation sécurité |
| `agentos/cupolas/` (Extensions) | Apache License 2.0 | Extensions architecture principale |
| `openlab/` (Écosystème) | MIT License | Marketplace agents/compétences, contributions communauté |
