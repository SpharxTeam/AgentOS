...
#### 常见错误信息
```
ConfigError: Invalid configuration file: /etc/agentos/manuals/manager.yaml
...
```bash
# 查看 API 服务日志
tail -f /var/log/agentos/manuals/api.log

# 过滤错误日志
grep -i "error\|exception\|failed" /var/log/agentos/manuals/api.log
