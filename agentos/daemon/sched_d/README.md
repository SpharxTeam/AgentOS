...
### 服务配置 (agentos/manager/sched.yaml)
...
```bash
# 方式 1: 直接启动
./build/agentos/daemon/sched_d/agentos-sched-d

# 方式 2: 指定配置文件
./build/agentos/daemon/sched_d/agentos-sched-d --manager ../agentos/manager/service/sched_d/sched.yaml
...
```bash
# 检查优先级配置
curl http://localhost:8083/api/v1/agentos/manager/priority
