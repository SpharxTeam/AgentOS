...
/**
 * @brief 更新峰值内存使用量
 * @note 必须在持�?mem_stats_mutex 时调用，使用 relaxed 内存顺序
 */
 ...
 * @brief 确保内存子系统已初始�?
 * @return 0 成功�?1 失败
 * @note 线程安全的延迟初始化，使用内存屏障保证正确�?
 */
static int ensure_initialized(void) {
    /* 快速路径：已初始化（使�?acquire 语义�?*/
