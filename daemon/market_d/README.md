...
```json
{
  ...
  "config_path": "/var/agentos/manager/architect.yaml",
  "health_score": 0.98
}
```
...
# 方式 2: 指定配置文件
./build/daemon/market_d/agentos-market-d --manager ../manager/service/market_d/market.yaml

# 方式 3: 环境变量覆盖
MARKET_D_PORT=9000 ./build/daemon/market_d/agentos-market-d
```
...
cat > architect_agent.json << EOF
{
  ...
  "config_file": "/opt/agentos/manager/architect.yaml"
}
EOF
...
- [Agent 开发指南](../../paper/guides/folder/create_agent.md) - 如何创建 Agent
