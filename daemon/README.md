...
`daemon/` 是 AgentOS 的**用户态服务层（Service Layer）**，位于内核层之上、应用层之下，为智能体运行时提供完整的后端服务支持。
...
# 启动网关服务
./build/daemon/gateway_d/gateway_d
...
### Q4: daemon/common 与 commons 的关系？

`daemon/common` 是 `commons` 统一基础库的**兼容层**：

| daemon/common | commons | 说明 |
|---------------|---------|------|
...
新代码建议直接使用 commons 的头文件，daemon/common 提供向后兼容。
...
### 架构文档
- [架构设计原则 Doc V1.7](../manuals/ARCHITECTURAL_PRINCIPLES.md)
- [内核层架构](../atoms/README.md)
- [统一基础库](../commons/README.md)
- [三层认知循环](../manuals/architecture/coreloopthree.md)
- [四层记忆系统](../manuals/architecture/memoryrovol.md)
- [系统调用规范](../manuals/architecture/syscall.md)

### 开发指南
- [快速开始](../manuals/guides/getting_started.md)
- [创建 Agent](../manuals/guides/create_agent.md)
- [创建技能](../manuals/guides/create_skill.md)
