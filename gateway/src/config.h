 ...
 * @brief 配置管理器接口
 *
 * 支持从配置文件加载、环境变量覆盖、支持运行时更新。
 * 使用 JSON 格式配置文件，支持热重载。
 *
 * @copyright (c) 2026 SPHARX. All Rights Reserved.
 */
 ...
 * @brief 创建配置管理器
 *
 * @param config_path 配置文件路径，若为NULL使用默认配置
 * @return 配置管理器，失败返回NULL
 *
 ...
 * @brief 重新加载配置
 * @param mgr 配置管理器
 * @param config_path 新的配置文件路径，若为NULL使用当前路径
 ...
 * @brief 获取完整配置
 * @param mgr 配置管理器
 * @param out_config 输出配置结构（调用者负责管理内存）
 * @return AGENTOS_SUCCESS 成功
 */
 ...
 * @brief 获取服务器配置
 * @param mgr 配置管理器
 * @param out_config 输出服务器配置（调用者负责管理内存）
 * @return AGENTOS_SUCCESS 成功
 */
 ...
 * @brief 获取日志配置
 * @param mgr 配置管理器
 * @param out_config 输出日志配置（调用者负责管理内存）
 * @return AGENTOS_SUCCESS 成功
 */
 ...
 * @brief 获取安全配置
 * @param mgr 配置管理器
 * @param out_config 输出安全配置（调用者负责管理内存）
 * @return AGENTOS_SUCCESS 成功
 */
