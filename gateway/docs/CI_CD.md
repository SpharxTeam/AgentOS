# AgentOS gateway Module CI/CD 配置文档

| 文档信息 | |
|---------|---------|
| **版本** | v1.0.0 |
| **编制日期** | 2026-03-24 |
| **适用模块** | AgentOS gateway Module |
| **文档状态** | 正式发布 |
...
```
gateway-v主版本.次版本.修订版本[-预发布版本]

示例:
- gateway-v1.0.0        # 正式版
- gateway-v1.1.0-beta.1 # Beta版
- gateway-v1.2.0-rc.1   # 候选版
```

### 5.2 发布流程

1. **创建标签**: `git tag gateway-v1.0.0`
2. **推送标签**: `git push origin gateway-v1.0.0`
...
```bash
# Kubernetes 回滚
kubectl rollout undo deployment/agentos-gateway -n agentos-gateway
