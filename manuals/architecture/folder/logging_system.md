...
int main(int argc, char* argv[]) {
    ...
    svc_config_load("manager/llm.yaml", &manager);
...
#### 位置：`toolkit/python/agentos/logger.py`
...
#### 位置：`toolkit/go/agentos/logger.go`
...
```c
// C 语言服务端 (daemon/tool_d/src/main.c)
...
**全局配置**: `manager/logging/logging.yaml`
