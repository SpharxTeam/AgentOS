...
```html
<!-- 在浏览器中使用 -->
<script src="https://cdn.jsdelivr.net/npm/@agentos/manuals-toolkit/dist/browser/manuals.min.js"></script>
```
...
```typescript
import { RealtimeClient } from '@agentos/manuals-toolkit/realtime';
...
import { 
  ...
  RateLimitError,
  ServerError 
} from '@agentos/manuals-toolkit/errors';
...
```typescript
import { RetryConfig, withRetry } from '@agentos/manuals-toolkit/utils';
...
```typescript
// 从环境变量创建客户端
import { loadConfigFromEnv } from '@agentos/manuals-toolkit/manager';
...
// 3. 使用流式处理
import { createDocumentStream } from '@agentos/manuals-toolkit/streams';
...
```typescript
// 1. 安全存储API密钥
import { SecureStorage } from '@agentos/manuals-toolkit/security';
...
// 2. 输入验证
import { validateDocumentInput } from '@agentos/manuals-toolkit/validation';
...
```typescript
// 获取SDK版本信息
import { version } from '@agentos/manuals-toolkit/package.json';
