...
│
├── daemon/                       # Core background services (user-space)
...
│
├── manuals/                    # Technical documentation center
...
See: [CoreLoopThree Architecture Document](manuals/architecture/coreloopthree.md)
...
See: [MemoryRovol Architecture Document](manuals/architecture/memoryrovol.md)
...
See: [Logging System Architecture Document](manuals/architecture/logging_system.md)
...
- [📘 CoreLoopThree Architecture](manuals/architecture/coreloopthree.md) - Three-layer runtime
- [💾 MemoryRovol Architecture](manuals/architecture/memoryrovol.md) - Memory roll system
- [🔧 IPC Mechanism](manuals/architecture/ipc.md) - Inter-process communication
- [⚙️ Microkernel Design](manuals/architecture/microkernel.md) - Microkernel architecture
- [📞 System Calls](manuals/architecture/syscall.md) - System call interface
- [📝 Logging System](manuals/architecture/logging_system.md) - Cross-language logging

### Development Guides

- [🚀 Quick Start](manuals/guides/getting_started.md) - Getting started guide
- [🤖 Create Agent](manuals/guides/create_agent.md) - Agent development tutorial
...
- [📋 Coding Standards](manuals/specifications/coding_standards.md) - Development standards
- [🧪 Testing Standards](manuals/specifications/testing.md) - Testing requirements
- [🔒 Security Standards](manuals/specifications/security.md) - Security practices
- [📊 Performance Metrics](manuals/specifications/performance.md) - Performance requirements
...
| `cupolas/` (Extensions) | Apache License 2.0 | Core architecture extension modules, consistent with kernel license |
