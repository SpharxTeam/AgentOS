...
```
5 分钟快速开始 → 架构概览 → 创建第一个 Agent → 部署运行
```

1. **[快速开始](guides/getting_started.md)** — 环境搭建与 Hello World（5 分钟）
2. **[架构设计原则](architecture/folder/architectural_design_principles.md)** — 理解五维正交设计体系
...
2. **[微内核设计](architecture/folder/microkernel.md)** — CoreKern 原子机制
3. **[三层认知运行时](architecture/folder/coreloopthree.md)** — CoreLoopThree 架构
4. **[四层记忆系统](architecture/folder/memoryrovol.md)** — MemoryRovol 卷载架构
5. **[系统调用设计](architecture/folder/syscall.md)** — Syscall 接口契约
...
2. **[架构设计原则 V1.6](architecture/folder/architectural_design_principles.md)** — 五维正交原则体系
...
```
manuals/
├── 📐 architecture/          # 架构设计文档（7 篇核心论文）
│   ├── folder/
│   │   ├── architectural_design_principles.md  ⭐ 架构设计原则 V1.6
...
AgentOS 架构设计基于**五维正交系统**，从五个维度定义设计原则：

| 维度 | 原则数量 | 核心理念 | 关键文档 |
|------|----------|----------|----------|
| **系统观 (S)** | S-1 ~ S-4 | 反馈闭环、层次分解、总体设计部、涌现性管理 | [架构设计原则](architecture/folder/architectural_design_principles.md) |
| **内核观 (K)** | K-1 ~ K-4 | 极简内核、接口契约、服务隔离、可插拔策略 | [微内核设计](architecture/folder/microkernel.md) |
...
**详细文档**: [安全穹顶设计](architecture/folder/architectural_design_principles.md#安全穹顶-cupolas)
...
**推荐阅读顺序**:
1. [架构设计原则 V1.6](architecture/folder/architectural_design_principles.md) — 五维正交原则体系
...
| 主题 | 核心文档 | 相关文档 |
|------|---------|---------|
| **微内核架构** | [微内核设计](architecture/folder/microkernel.md) | [架构设计原则](architecture/folder/architectural_design_principles.md) |
...
| **安全穹顶** | [架构设计原则 - cupolas 章节](architecture/folder/architectural_design_principles.md) | [安全设计指南](specifications/coding_standard/Security_design_guide.md) |
...
| 主题 | 核心文档 | 相关文档 |
|------|---------|---------|
| **工程两论** | [架构设计原则 - 理论基础](architecture/folder/architectural_design_principles.md) | [设计原则](philosophy/folder/Design_Principles.md) |
| **双系统认知** | [认知理论](philosophy/folder/Cognition_Theory.md) | [CoreLoopThree](architecture/folder/coreloopthree.md) |
| **微内核哲学** | [微内核设计](architecture/folder/microkernel.md) | [架构设计原则 - 内核观](architecture/folder/architectural_design_principles.md) |
| **术语规范** | [统一术语表 V1.6](specifications/TERMINOLOGY.md) | [词汇索引](specifications/agentos_contract/glossary_index.md) |
...
| **安全穹顶** | Cupolas | 虚拟工位、权限裁决、输入净化、审计追踪四重防护 | [架构设计原则](architecture/folder/architectural_design_principles.md) |
...
[![Documentation Status](https://img.shields.io/badge/docs-V1.6-blue)](README.md)
