...
|---------|------|---------|---------|------|
| [Manager Config Integration Standard](./INTEGRATION_STANDARD.md) | v1.0.0 | manager ↔ commons/utils/config_unified | 2026-04-01 | ✅ Production Ready |

### 计划中的标准 / Planned Standards

| 标准名称 | 目标模块 | 计划发布日期 | 状态 |
|---------|---------|-------------|------|
| Gateway Integration Standard | gateway ↔ daemon/* | TBD | 📋 Planning |
