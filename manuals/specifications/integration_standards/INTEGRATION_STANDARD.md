...
**当前位置**: `agentos/manuals/specifications/integration_standards/` (从 `agentos/manager/` 迁移)
...
| v1.0.1 | 2026-04-03 | 文档迁移至 agentos/manuals/specifications/integration_standards/ |
...
| 日期 | 操作 | 原位置 | 新位置 |
|------|------|--------|--------|
| 2026-04-03 | 移动文档 | `agentos/manager/INTEGRATION_STANDARD.md` | `agentos/manuals/specifications/integration_standards/INTEGRATION_STANDARD.md` |

**迁移原因**: 集成标准属于项目级规范文档，应集中管理在 `agentos/manuals/specifications/` 下，便于跨模块查阅和维护。
