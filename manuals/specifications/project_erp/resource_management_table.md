...
本文档提供了 AgentOS (OpenApex) 中所有需要管理的资源及其释放责任的详细说明。资源管理是确保系统稳定性和防止资源泄漏的关键部分，所有开发者必须严格遵循本文档中的资源管理规范。本规范基于 AgentOS 架构设计原则 V1.6，特别是 **E-3 资源确定性原则** 和 **E-8 可测试性原则**，确保资源生命周期明确且可测试验证。
