...
```c
// 原代码
#include "../../../bases/utils/observability/logger.h"
...
# 添加统一日志模块
set(LOGGING_SOURCES
    bases/utils/logging/src/logging.c
    bases/utils/logging/src/atomic_logging.c
    bases/utils/logging/src/service_logging.c
    bases/utils/logging/src/logging_compat.c
)

# 添加包含目录
include_directories(
    bases/utils/logging/include
)
```
