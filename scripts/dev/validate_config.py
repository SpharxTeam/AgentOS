...
class ConfigValidator:
    ...
    def check_config_version(self) -> bool:
        ...
        for config_file in VERSION_CHECK_FILES:
            config_data = self.load_config(config_file)
    ...
    def check_environment_variables(self) -> bool:
        ...
        for config_file in ENV_VAR_CHECK_FILES:
            config_data = self.load_config(config_file)
            if not config_data:
                continue
...
def main():
    ...
    parser.add_argument('--manager', '-c',
                        default='manager',
                        help='配置目录路径')
    parser.add_argument('--schema', '-s',
                        default='manager/schema',
                        help='Schema 目录路径')
    ...
    validator = ConfigValidator(args.manager, args.schema)
