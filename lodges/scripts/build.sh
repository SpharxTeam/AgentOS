...
test() {
    ...
    if [ -f "tests/lodges_tests" ]; then
        ./tests/lodges_tests --output-on-failure
    else
...
benchmark() {
    ...
    if [ -f "tests/lodges_benchmark" ]; then
        ./tests/lodges_benchmark
    else
