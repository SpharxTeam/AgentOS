...
print_banner() {
    echo "========================================"
    echo "  AgentOS heapstore Build System"
...
test() {
    ...
    if [ -f "tests/heapstore_tests" ]; then
        ./tests/heapstore_tests --output-on-failure
    else
...
benchmark() {
    ...
    if [ -f "tests/heapstore_benchmark" ]; then
        ./tests/heapstore_benchmark
    else
