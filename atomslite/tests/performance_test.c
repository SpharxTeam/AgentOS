...
int main(void) {
    printf("=========================================\n");
    printf("    AgentOS AtomsLite Performance Test    \n");
    printf("=========================================\n");
    ...
    printf("The atomslite module should have lower resource consumption than the original atoms module.\n");
