...
func main() {
    ...
    // 创建 Agent
    agent, err := agentos.NewAgent(ctx, config)
    if err != nil {
...
// 绑定 Skill
func (a *Agent) BindSkill(ctx context.Context, name string, config map[string]interface{}) error
...
// 触发记忆进化
func (c *MemoryClient) Evolve(ctx context.Context, config map[string]interface{}) (*EvolutionStats, error)
