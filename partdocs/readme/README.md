...
// resources/locales/zh-CN/common.json
{
...
// resources/locales/de/common.json
{
...
**翻译协作平台配置**:
```yaml
# config/translation-platform.yaml
...
# 配置翻译工具
cp config/translation.example.yaml config/translation.yaml
# 编辑配置文件，设置你的偏好
```
