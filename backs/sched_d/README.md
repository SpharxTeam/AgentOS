...
```bash
# 方式 1: 直接启动
./build/backs/sched_d/agentos-sched-d

# 方式 2: 指定配置文件
./build/backs/sched_d/agentos-sched-d --config ../config/service/sched_d/sched.yaml
...
```bash
# 检查优先级配置
curl http://localhost:8083/api/v1/config/priority
...
- [CoreLoopThree 架构](../../partdocs/architecture/folder/coreloopthree.md) - 调度器理论根基
- [Agent 调度算法](../../partdocs/architecture/folder/coreloopthree.md#调度官评分函数) - 评分函数详解
