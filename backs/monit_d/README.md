...
```bash
# 方式 1: 直接启动
./build/backs/monit_d/agentos-monit-d

# 方式 2: 指定配置文件
./build/backs/monit_d/agentos-monit-d --config ../config/service/monit_d/monit.yaml
...
# 检查通知渠道配置
cat /var/agentos/config/monit_d/alert_channels.yaml
```
...
- [统一日志系统](../../partdocs/architecture/folder/logging_system.md) - 日志架构详解
- [OpenTelemetry 集成](../../partdocs/guides/folder/observability.md) - 可观测性指南
