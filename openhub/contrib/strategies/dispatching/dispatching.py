...
for the OpenHub platform. It analyzes task requirements and matches them
...
class DispatchingStrategy:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.capability_weight = config.get("capability_weight", 0.4)
        self.priority_weight = config.get("priority_weight", 0.3)
        self.load_weight = config.get("load_weight", 0.3)
