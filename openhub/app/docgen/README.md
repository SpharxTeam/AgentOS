...
```bash
# 运行文档生成
python -m openhub.app.docgen.main --input ./src --output ./docs

# 指定语言
python -m openhub.app.docgen.main --input ./src --output ./docs --lang zh,en

# 生成架构图
python -m openhub.app.docgen.main --input ./src --output ./docs --with-diagrams
```
