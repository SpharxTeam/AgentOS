...
```bash
# 启动科研智能体
python -m openhub.app.research.main --config config.yaml

# 文献检索模式
python -m openhub.app.research.main --mode literature_search --query "deep learning"

# 数据分析模式
python -m openhub.app.research.main --mode data_analysis --input ./data.csv
```
