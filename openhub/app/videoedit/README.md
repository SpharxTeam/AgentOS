# OpenHub App - VideoEdit (视频编辑智能体应用)
...
```bash
# 启动视频编辑智能体
python -m openhub.app.videoedit.main --config config.yaml

# 自动剪辑模式
python -m openhub.app.videoedit.main --mode auto_edit --input ./video.mp4

# 字幕生成模式
python -m openhub.app.videoedit.main --mode subtitle --input ./video.mp4 --lang zh
```
